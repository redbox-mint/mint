...
class IndexData:
    ...
    def __metadata(self):
        ...
        self.utils.add(self.index, "feature class", data.get("feature class"))
        self.utils.add(self.index, "feature code", data.get("feature code"))
        self.utils.add(self.index, "country code", data.get("country code"))
        self.utils.add(self.index, "cc2", data.get("cc2"))
        self.utils.add(self.index, "admin1 code", data.get("admin1 code"))
        self.utils.add(self.index, "admin2 code", data.get("admin2 code"))
        self.utils.add(self.index, "admin3 code", data.get("admin3 code"))
        self.utils.add(self.index, "admin4 code", data.get("admin4 code"))
        ...
        self.utils.add(self.index, "modification date", data.get("modification date"))
